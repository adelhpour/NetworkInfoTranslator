...
class NetworkInfoExportToFigureBase(NetworkInfoExportBase):
            ...
            if 'graphicalShape' in list(features.keys()):
                ...
                if 'geometricShapes' in list(features['graphicalShape'].keys()):
                    for gs_index in range(len(features['graphicalShape']['geometricShapes'])):
                        ...
                        if features['graphicalShape']['geometricShapes'][gs_index]['shape'] == 'image':
                            self.draw_image(features['graphicalShape']['geometricShapes'][gs_index],
                                       bbox_x, bbox_y, bbox_width, bbox_height, offset_x, offset_y, slope, z_order)
                    ...
                    self.draw_simple_rectangle(features['graphicalShape']['geometricShapes'][gs_index],
                                               bbox_x, bbox_y, bbox_width, bbox_height, offset_x, offset_y,
                                               stroke_color, stroke_width, stroke_dash_array, fill_color,
                                               slope, z_order)
    ...
    def add_line_endings_to_scene(self, features):
        print("adding line ending to scene")

    def draw_image(self, image_shape, bbox_x, bbox_y, bbox_width, bbox_height, offset_x, offset_y, slope, z_order):
        pass

    def draw_render_curve(self, curve_shape, bbox_x, bbox_y, bbox_width, bbox_height, stroke_color, stroke_width,
                          stroke_dash_array):
        pass

    def draw_rounded_rectangle(self, rectangle_shape, bbox_x, bbox_y, bbox_width, bbox_height, stroke_color,
                               stroke_width, stroke_dash_array, fill_color, offset_x, offset_y, slope, z_order):
        pass

    def draw_simple_rectangle(self, bbox_x, bbox_y, bbox_width, bbox_height, stroke_color, stroke_width,
                              stroke_dash_array, fill_color, offset_x, offset_y, slope, z_order):
        pass

    def draw_ellipse(self, ellipse_shape, bbox_x, bbox_y, bbox_width, bbox_height, offset_x, offset_y, stroke_color,
                     stroke_width, stroke_dash_array, fill_color, slope, z_order):
        pass

    def draw_polygon(self, polygon_shape, bbox_x, bbox_y, bbox_width, bbox_height, offset_x, offset_y, slope, z_order):
        pass

    def export(self, file_name):
        print("we are in the export of skia")


"""
class NetworkInfoExportToSkia(NetworkInfoExportBase):
    def __init__(self):
